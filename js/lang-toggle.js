...
(function () {
  ...
  const translations = {
    en: {
      ...
      "history.story.p1": "Delia learned early that a good life begins with a good lesson. In El Salvador, she was the teacher her students remembered not just for homework, but for the respectful way she said their names. Jorge first noticed her crossing a courtyard where the afternoon light turned chalk dust to gold. He admired her curiosity, her faith, and the quiet way she organized chaos with care.",
      "history.story.p2": "They united their talents before marriage: Delia's constancy and love of learning, Jorge's courage and ingenuity. Upon arriving in Denver, they found a small space on Colorado Boulevard – 'the size of a closet,' he joked. The shelves were low, the hours long, and the dream taller than both. They stocked what felt like home: maseca, coffee, sweet bread, and conversations that turn a stranger into a neighbor.",
      "history.story.p3": "Growth came like morning – slow and reliable. One customer brought a friend, a friend brought a family, and soon the store became a meeting place for memory. Pupusas united generations; the aroma of loroco and quesillo drew out stories like songs. Delia kept a notebook by the register for names and needs. Jorge watched the door, greeting everyone with the same warmth as the first day.",
      "history.story.p4": "For more than thirty years, the store was more than a business. It became a promise: that immigrants can plant roots anywhere and give shade to others. There were difficult seasons – broken freezers, tight budgets, long nights – but faith stitched the hard days into a larger fabric. Every decision followed a simple question: Will this help our community feel at home?",
      "history.story.p5": "Today, Tienda Salvadoreña is a living album. On the shelves, you see the flavor of a country. In the smiles, you feel the warmth of a classroom. In the laughter around the hot comal, you hear the pulse of family. Jorge and Delia built more than a store: they made a place where culture isn't just remembered; it's shared. That's their legacy: visible love, one pupusa at a time.",
    ...
    es: {
      ...
      "history.story.p1": "Delia aprendió temprano que una buena vida comienza con una buena lección. En El Salvador, fue la maestra que sus estudiantes recordaban no solo por las tareas, sino por la forma respetuosa en que decía sus nombres. Jorge la notó por primera vez cruzando un patio donde la luz de la tarde convertía el polvo de tiza en oro. Admiraba su curiosidad, su fe y la manera tranquila en que organizaba el caos con cuidado.",
      "history.story.p2": "Unieron sus talentos antes de casarse: la constancia y el amor por el aprendizaje de Delia, la valentía y el ingenio de Jorge. Al llegar a Denver, encontraron un pequeño local en Colorado Boulevard – \"del tamaño de un clóset\", bromeaba él. Los estantes eran bajos, las horas largas y el sueño más alto que ambos. Abastecieron lo que se sentía como casa: maseca, café, pan dulce y conversaciones que convierten a un desconocido en vecino.",
      "history.story.p3": "El crecimiento llegó como la mañana – lento y confiable. Un cliente trajo a un amigo, un amigo trajo a una familia, y pronto la tienda se convirtió en un lugar de encuentro para la memoria. Las pupusas unieron generaciones; el aroma de loroco y quesillo sacaba historias como canciones. Delia llevaba un cuaderno junto a la caja para nombres y necesidades. Jorge cuidaba la puerta, saludando a todos con el mismo calor del primer día.",
      "history.story.p4": "Durante más de treinta años, la tienda fue más que un negocio. Se convirtió en una promesa: que los inmigrantes pueden plantar raíces en cualquier lugar y dar sombra a otros. Hubo temporadas difíciles – congeladores descompuestos, presupuestos ajustados, noches largas – pero la fe cosió los días duros en un tejido mayor. Cada decisión seguía una pregunta sencilla: ¿Ayudará esto a que nuestra comunidad se sienta en casa?",
      "history.story.p5": "Hoy, Tienda Salvadoreña es un álbum vivo. En los estantes, ves el sabor de un país. En las sonrisas, sientes el calor de un aula. En la risa alrededor del comal caliente, escuchas el pulso de la familia. Jorge y Delia construyeron más que una tienda: hicieron un lugar donde la cultura no solo se recuerda; se comparte. Ese es su legado: amor visible, una pupusa a la vez.",
